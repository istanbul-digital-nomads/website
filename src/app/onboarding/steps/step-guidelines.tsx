...
export function StepGuidelines({ data, updateField, errors }: StepProps) {
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-primary-200/30 bg-primary-50/30 p-5 dark:border-[rgba(200,100,60,0.1)] dark:bg-[rgba(200,100,60,0.04)]">
        <ul className="space-y-3">
          {GUIDELINES.map((rule, i) => (
            <li
              key={i}
              className="flex gap-3 text-sm text-[#5a4f43] dark:text-[#d4c4b4]"
            >
      ...
      <div data-field="agrees_guidelines">
        <label className="flex cursor-pointer items-start gap-3 rounded-xl border border-primary-200/30 bg-white/50 p-4 transition-colors hover:bg-primary-50/30 dark:border-[rgba(200,100,60,0.1)] dark:bg-[#231a14]/50 dark:hover:bg-[rgba(200,100,60,0.06)]">
          <input
            type="checkbox"

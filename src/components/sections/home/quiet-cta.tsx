    ...
    <section className="bg-ink-1 py-32 text-center lg:py-44">
      <Container>
        ...
        <h2 className="mx-auto mt-8 max-w-4xl font-display text-h1 leading-none text-paper lg:text-display-lg">
          {t("line1")}{" "}
          <span className="italic text-terracotta-ink">{t("line2")}</span>{" "}
          <span className="text-paper-mute">{t("line3")}</span>
        </h2>
        <div className="mt-14 flex flex-wrap justify-center gap-3">
          <Link
            href="/plans"
            className="group inline-flex items-center gap-1.5 bg-terracotta px-8 py-4 text-sm font-medium text-[#06101f] transition-colors duration-fast hover:bg-terracotta-dim"
          >
            {t("primary")}

      ...
      <div className="fixed left-1/2 top-[10vh] z-[101] w-[min(680px,calc(100vw-24px))] -translate-x-1/2 overflow-hidden border border-ink-3 bg-ink-1 shadow-[0_24px_80px_rgba(0,0,0,0.45)] sm:top-[14vh]">
        ...
        >
          <div className="flex items-center gap-3 border-b border-ink-3 bg-ink-0/32 px-4">
            ...
            <span
              dir="ltr"
              className="hidden shrink-0 border border-ink-4 bg-ink-1 px-2 py-1 font-mono text-[10px] uppercase tracking-wider text-paper-faint sm:inline"
            >
              esc
            </span>
          </div>
          <Command.List className="max-h-[60vh] overflow-y-auto p-2">
            ...
            {groups.map((group) => (
              <Command.Group
                ...
                className={cn(
                  "mb-2 [&_[cmdk-group-heading]]:px-3 [&_[cmdk-group-heading]]:py-2 [&_[cmdk-group-heading]]:font-mono [&_[cmdk-group-heading]]:text-[10px] [&_[cmdk-group-heading]]:uppercase [&_[cmdk-group-heading]]:tracking-wider [&_[cmdk-group-heading]]:text-terracotta",
                  "[&_[cmdk-group-heading]]:text-start",
                )}
              >
                {group.items.map((item) => (
                  ...
                  >
                    ...
                    <span
                      dir="ltr"
                      className="shrink-0 font-mono text-[10px] uppercase tracking-wider text-paper-faint"
                    >
                      ↵
                    </span>
                  </Command.Item>
          ...
          <div
            className={cn(
              "flex items-center justify-between gap-4 border-t border-ink-3 px-4 py-2.5 text-start font-mono text-[10px] uppercase tracking-wider text-paper-faint",
            )}
          >
            <span>{t("footnote")}</span>
            <span className="hidden sm:inline">{t("openHint")}</span>
          </div>
        </Command>
      </div>
    </div>

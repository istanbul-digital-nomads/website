...
This isn't just geography - it shapes identity. European-side residents joke about "never crossing to Asia" and vice versa. The Bosphorus is both a physical and cultural divider. As a nomad, you will likely develop a preference. Both sides have distinct personalities.

### Cats

Istanbul is famous for its street cats. They are everywhere, well-fed, and generally friendly. There is even a documentary about them ([Kedi](https://en.wikipedia.org/wiki/Kedi_(2016_film))). Don't be surprised when a cat sits on your laptop at a cafe. This is normal.

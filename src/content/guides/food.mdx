...
6. **Vegetarian options** exist but are not always labeled. Ask "Etsiz var mi?" (Do you have meatless options?). Lentil soup, pide with cheese, borek, and many meze are vegetarian.

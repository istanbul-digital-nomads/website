...
export function validateUpdateEvent(body: unknown): Result<UpdateEventBody> {
  ...
  if (b.location_name !== undefined) data.location_name = b.location_name as string;
  if (b.location_address !== undefined) data.location_address = (b.location_address as string) ?? null;
  if (b.location_url !== undefined) data.location_url = (b.location_url as string) ?? null;
  if (b.capacity !== undefined) data.capacity = typeof b.capacity === "number" ? b.capacity : null;
  if (b.image_url !== undefined) data.image_url = (b.image_url as string) ?? null;
...
export function validateUpdateMember(body: unknown): Result<UpdateMemberBody> {
  ...
  const ALLOWED = [
    ...
    "skills", "website", "telegram_handle", "is_visible",
  ];
